  ...
  data.forEach((blogPost) => {
    ...
    const template = `
        ...
        <div class="desc" style="background-color: transparent;">
            ...
            <img class="info-icon" onmouseover="displayInfo(this)" onclick="displayInfo(this)" onmouseleave="removeInfo(this)" src="assets/illustrations/icons/icon-info-cloud-desktop.svg" alt="click here to see picture description">
        </div>
